    ...
    <>
      <div className="flex flex-col justify-center items-center rounded-2xl p-4 bg-white relative">
        ...
        <div className="z-10 text-center ">
          ...
          {props.Auth ? (
            <div className="p-4 m-4">
              <h1 className="text-3xl font-semibold">props.Auth</h1>
              <button className="text-xl font-semibold bg-red-200 rounded-2xl p-4 mt-4">
        ...
        <div className="flex flex-col md:flex-row justify-between relative">
          ...
          <select className="bg-gray-300 rounded-2xl m-2 p-4 cursor-pointer z-20" onChange={(e)=>{
            props.setModels(e.target.value);
          }}>
